...
Boards used in construction: Arduino nano
...
3. Scavenge a keyboard input solution (USB, or Serial)
...
void setup(){
  Serial.begin(115200);//maximum serial speed for graphics AVR
  
}

void loop(){
  //work will begin here
}
